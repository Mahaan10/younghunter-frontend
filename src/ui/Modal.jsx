...
function Modal({ onClose, children, title }) {
  ...
  return (
    <div className="backdrop-blur-sm fixed top-0 left-0 w-full h-screen bg-slate-950 bg-opacity-30 z-50">
      <div
        ref={ref}
        className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
        rounded-lg bg-slate-950 p-4 shadow-lg transition-all duration-500 ease-out
